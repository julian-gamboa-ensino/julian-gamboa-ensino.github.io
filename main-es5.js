(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /home/julian/Desktop/julian-gamboa-ensino.github.io/fonte-numerador-janela-dupla/src/main.ts */
      "zUnb");
      /***/
    },
      ...
      */
      ...
      var GetFotosBucketService = /*#__PURE__*/function () {
        ...
        function GetFotosBucketService(httpClient) {
          ...
          "https://cv-julian-2022.s3.us-west-2.amazonaws.com/conteudo_pasta/"; // Headers
        ...
        _createClass(GetFotosBucketService, [{
          ...
          value: function getUrl_imagem(etiqueta) {
            return this.httpClient.get(this.url + etiqueta + ".json").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["retry"])(2), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError));
      ...
      */
      ...
      var GetListaPastasService = /*#__PURE__*/function () {
        ...
        function GetListaPastasService(httpClient) {
          ...
          this.httpClient = httpClient;
          this.url = "https://cv-julian-2022.s3.us-west-2.amazonaws.com/pastas.json"; // Headers
      ...
      var ComparadorImagensComponent = /*#__PURE__*/function () {
        ...
        _createClass(ComparadorImagensComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.preparacion_eventos_DOM_abril_2022(); // ??    setTimeout(() => { },500);
          ...
          value: function temporizador_elementos_DOM_abril_2022(inicial) {
            ...
            this.intervalo = setInterval(function () {
              var previo = _this6.slider.style.left;

              if (_this6.slider.style.left === '0px') {
                _this6.slider.style.left = inicial;
                _this6.img.style.width = inicial;
              } else {
                _this6.slider.style.left = '0px';
                _this6.img.style.width = '0px';
              } //console.log(" event");
